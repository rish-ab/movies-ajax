...
<head>
  ...
  <title>MoviePoint Ticket Booking</title>
  <style type="text/css">
          ...
          <center>
            <table class="w320" cellspacing="0" cellpadding="0" width="500">
              <tr>
                ...
                <table cellspacing="0" cellpadding="0" width="100%" style="margin-top: 100px;">
                  <tr>
                  ...
                  <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#E5E5E5">
                    <tr>
                      <td class="center" style="padding:25px; text-align:center;">
                        <b><a href="{{ CONTACTUS_URL }}">Get in touch</a></b> if you have any questions or feedback
                      </td>
                    </tr>
                  </table>
                </td>

<div class="content-wrapper">
    ...
    <div class="row">
      <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title text-center">Tickets Booked</h4>
            <!-- <p class="card-description"> Basic form layout </p> -->
            ...
            <table class="table table-bordered datatable" style="margin-top: 20px;">
                ...
                <tbody>
                    <?php $count = 0; foreach ($tickets as $ticket): $count++; ?>
                        <tr>
                            <td><?= $count; ?></td>
                            ...
                            <td>
                                <p><?= $ticket->username; ?></p>
                                <p><?= $ticket->email; ?></p>
                                <p><?= $ticket->mobile_number; ?></p>
                            </td>
                            
                            <td><?= $ticket->cinema_name; ?></td>
                            <td><?= $ticket->tickets; ?></td>
                            <td><?= date('d M, Y - h:i A', strtotime($ticket->movie_time)); ?></td>

                            <td>
                                <form method="POST" action="<?= URL; ?>admin/cancel_ticket" onsubmit="return confirm('Are you sure you want to cancel this booking ?');">
                                    <?= Security::csrf_token(); ?>
                                    <input type="hidden" name="ticket_ids" value="<?= $ticket->ticket_ids; ?>">
                                    <input type="hidden" name="selected_seats" value="<?= $ticket->tickets; ?>">
                                    <input type="submit" name="submit" value="Cancel booking" class="btn btn-danger btn-sm">
                                </form>
                            </td>
                        </tr>
                    <?php endforeach; ?>

...
<section class="video ptb-90">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title pb-20">
                    <h1><i class="icofont icofont-film"></i> Seasons</h1>
                </div>
            </div>
        </div>
        <hr />
        <div class="row">
            <div class="col-md-9">
                <div class="video-area">
                    ...
                    <?php
                        if (count($seasons) > 0):
                            if (count($seasons[0]->episodes) > 0):
                    ?>
                            <img src="<?= URL . $seasons[0]->episodes[0]->poster; ?>" class="movie-thumbnail-trailers" alt="<?= URL . $seasons[0]->episodes[0]->poster; ?>" />
                        <?php endif; ?>

                        <div class="video-text">
                            <h2>
                                <a href="<?= URL . 'season/detail/' . $seasons[0]->id; ?>">
                                    <?= $seasons[0]->name; ?>
                                </a>
                            </h2>
                        </div>
                ...
                <div class="row">
                    ...
                    <?php
                        ...
                        for ($a = 1; $a < count($seasons); $a++):
                            ...
                            if (count($seasons[$a]->episodes) > 0):
                    ?>

                            <img style="width: 100%; height: 200px; object-fit: cover;" src="<?= URL . $seasons[$a]->episodes[0]->poster; ?>" alt="video" />
                        ...
                        ?>
                                <div class="video-text">
                                    <h4>
                                        <a href="<?= URL . 'season/detail/' . $seasons[$a]->id; ?>">
                                            <?= $seasons[$a]->name; ?>
                                        </a>
                                    </h4>
                                </div>
